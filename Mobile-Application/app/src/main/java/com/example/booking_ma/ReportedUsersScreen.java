...
public class ReportedUsersScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPager.setAdapter(new com.example.booking_ma.ReportedUsersScreen.ViewPagerAdapter(this));
    ...
    private String getTabTitle(int position) {
        switch (position) {
            case 0:
                return "Reported guests";
            case 1:
                return "Reported owners";
            default:
                return "";
        }
    }

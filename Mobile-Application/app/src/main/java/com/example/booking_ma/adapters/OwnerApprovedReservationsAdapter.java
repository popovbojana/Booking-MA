...
public class OwnerApprovedReservationsAdapter  extends RecyclerView.Adapter<OwnerApprovedReservationsAdapter.ViewHolder>{

    private List<ReservationDisplayDTO> ownerApprovedReservations;
    private Context context;
    private String token;

    public OwnerApprovedReservationsAdapter(Context context, List<ReservationDisplayDTO> ownerApprovedReservations, String token) {
        this.context = context;
        this.ownerApprovedReservations = ownerApprovedReservations;
        this.token = token;
    }

    @Override
    public OwnerApprovedReservationsAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_reservation, parent, false);
        return new OwnerApprovedReservationsAdapter.ViewHolder(view);
    }
    ...
    public int getItemCount() {
        return ownerApprovedReservations.size();
    }

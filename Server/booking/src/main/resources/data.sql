...
--accommodations
insert into ACCOMMODATIONS(approved, cancellation_deadline_in_days, has_changes, max_guests, min_guests, price_type, change_id, owner_id, amenities, description, name, type, address, latitude, longitude, final_rating, standard_price, auto_approve) values (true, 5, false, 4, 2, 'PER_GUEST', null, 3, 'Wifi, parking', 'Opis', 'Najbolji hotel na svetu', 'Hotel', 'Jug Bogdana 11, Novi Sad', 45.266350, 19.844850, 0.0, 10.00, false)
insert into AVAILABILITY_PRICES(amount, accommodation_id, date_from, date_until) values (20, 1, '2023-10-20T00:00:00', '2023-10-25T00:00:00')
insert into AVAILABILITY_PRICES(amount, accommodation_id, date_from, date_until) values (20, 1, '2024-10-20T00:00:00', '2024-10-21T00:00:00')
...
insert into AVAILABILITY_PRICES(amount, accommodation_id, date_from, date_until) values (30, 2, '2024-10-20T00:00:00', '2024-10-31T00:00:00')
insert into AVAILABILITY_PRICES(amount, accommodation_id, date_from, date_until) values (20, 2, '2024-10-31T00:00:00', '2024-11-15T00:00:00')
...
--reservations
insert into RESERVATIONS(guest_id, owner_id, accommodation_id, check_in, check_out, guests_number, total_cost, reservation_state, cancelation_deadline, guest_cancelations_number) values (2, 3, 2, '2023-10-20T00:00:00', '2023-10-25T00:00:00', 4, 100.00, 'DENIED', '2023-10-17T00:00:00', 0)
insert into RESERVATIONS(guest_id, owner_id, accommodation_id, check_in, check_out, guests_number, total_cost, reservation_state, cancelation_deadline, guest_cancelations_number) values (2, 3, 2, '2023-10-20T00:00:00', '2023-10-25T00:00:00', 4, 100.00, 'APPROVED', '2023-10-17T00:00:00', 0)
insert into RESERVATIONS(guest_id, owner_id, accommodation_id, check_in, check_out, guests_number, total_cost, reservation_state, cancelation_deadline, guest_cancelations_number) values (2, 3, 2, '2024-10-21T00:00:00', '2024-10-30T00:00:00', 4, 100.00, 'PENDING', '2024-10-27T00:00:00', 0)
insert into RESERVATIONS(guest_id, owner_id, accommodation_id, check_in, check_out, guests_number, total_cost, reservation_state, cancelation_deadline, guest_cancelations_number) values (2, 3, 2, '2024-10-21T00:00:00', '2024-10-30T00:00:00', 4, 100.00, 'PENDING', '2024-10-27T00:00:00', 0)

...
--accommodations
insert into ACCOMMODATIONS(approved, cancellation_deadline_in_days, has_changes, max_guests, min_guests, price_type, change_id, owner_id, amenities, description, name, type, address, latitude, longitude) values (true, 5, false, 4, 2, 'PER_GUEST', null, 3, 'Wifi, parking', 'Opis', 'Najbolji hotel na svetu', 'Hotel', 'Jug Bogdana 11, Novi Sad', 45.266350, 19.844850)
...
insert into ACCOMMODATIONS(approved, cancellation_deadline_in_days, has_changes, max_guests, min_guests, price_type, change_id, owner_id, amenities, description, name, type, address, latitude, longitude) values (true, 3, false, 5, 3, 'PER_UNIT', null, 3, 'Wifi', 'Opis', 'Najbolji motel na svetu', 'Motel', 'Takovska 6, Novi Sad', 45.251720, 19.832240)
